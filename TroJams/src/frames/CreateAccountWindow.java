...
public class CreateAccountWindow extends JFrame {
	...
	private void createGUI(){
		...
		firstNameTextField.setPreferredSize(new Dimension(10, 60));
		lastNameTextField.setPreferredSize(new Dimension(10, 60));
		usernameTextField.setPreferredSize(new Dimension(10, 60));
		passwordTextField.setPreferredSize(new Dimension(10, 60));
		...
		Image image = new ImageIcon("images/silhouette.png").getImage();
		silhouette = new ImageIcon(image.getScaledInstance(200, 200, java.awt.Image.SCALE_SMOOTH));
		imageLabel.setIcon(silhouette);
